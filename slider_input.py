...
class Sliders:
    ...
    def __init__(self):
        ...
        self.Sphi = mySlider(num_of_sliders=self.num_of_sliders,slider_number=1, maxV=90, minV=-90, intV=0, gain=np.pi / 180, name='Roll/Phi')
        self.Stheta = mySlider(num_of_sliders=self.num_of_sliders, slider_number=2, maxV=90, minV=-90, intV=0, gain=np.pi / 180, name='Pitch/Theta')
        self.Spsi = mySlider(num_of_sliders=self.num_of_sliders,slider_number=3, maxV=90, minV=-90, intV=0,gain=np.pi / 180, name='Yaw/Psi')
...
class mySlider:
    ...
    def __init__(self,num_of_sliders=1, slider_number=1, maxV = 1, 
        ...
        self.axSlider = plt.axes([0.5-self.Slider_length/2,hpos, self.Slider_length, 
            self.Slider_width], axisbg = 'white')
